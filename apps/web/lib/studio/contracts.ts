...
export type AgenticCanvasBlock =
  ...
  | (AgenticCanvasBlockBase & { type: "CUSTOM_VISUAL"; artifact_instance_id: string; bridge_nonce: string; custom_visual_build_id: string; manifest_digest: string; parameters: Record<string, string | number | boolean>; semantic_interactions?: Array<{ semantic_id: string; action: AgenticCanvasAction; value_required: boolean }> });
