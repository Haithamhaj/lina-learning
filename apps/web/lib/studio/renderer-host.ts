...
const approvedContracts: readonly ApprovedContract[] = [
  { renderer: "AGENTIC_CANVAS", subject_key: "CANVAS", subject_profile_version: "agentic-canvas-profile-v3", activity_key: "agentic_canvas", activity_contract_version: "agentic-canvas-activity-v1", renderer_key: "agentic-canvas", renderer_version: "agentic-canvas-renderer-v3", payload_schema_version: "agentic-canvas-scene-v3" },
  ...
  },
  {
    ...
    renderer_key:'decimal-place-value', renderer_version:'decimal-place-value-renderer-v1', payload_schema_version:'decimal-place-value-scene-v1',
  },
  {
    renderer:'MATH_DECIMAL_NUMBER_LINE', subject_key:'MATH', subject_profile_version:'subject-profile-v4',
  ...
  {
    renderer:'MATH_MAKE_TEN', subject_key:'MATH', subject_profile_version:'subject-profile-v4',
