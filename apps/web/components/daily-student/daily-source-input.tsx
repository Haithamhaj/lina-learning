...
export function DailySourceInput({
  ...
  return (
    <div className="order-1 sm:col-span-3">
      ...
      {localPreview ? <img src={localPreview} alt={copy.readyPreview(file?.name ?? "")} className="mt-2 max-h-40 max-w-64 rounded-xl border border-[#d9d3ff] object-contain" /> : null}
    </div>
  );
}
