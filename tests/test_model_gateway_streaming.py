...
def test_structured_v10_tutor_normalization_preserves_workspace_intent() -> None:
    ...
    output = _normalize_output(
        '{"text":"Try a number line.","suggested_actions":[],"workspace_intent":{"version":"workspace-intent-v1","action":"OPEN_ACTIVITY","subject_key":"MATH","concept_keys":["fraction-equivalence"],"learning_goal":"Compare equivalent fractions.","activity_hint":null,"representation_need":"VISUAL","expected_student_response_mode":"WORKSPACE","presentation_sequence":"PARALLEL","source_references":[],"safe_text_fallback":"Let us compare the fractions."},"canvas_brief":null,"canvas_visual_context_selection":null,"workspace_visual_order":null}',
        {"response_schema": TUTOR_OUTPUT_RESPONSE_SCHEMA},
    )
    ...
    null_output = _normalize_output(
        '{"text":"Keep going.","suggested_actions":[],"candidate_metadata":null,"workspace_intent":null,"canvas_brief":null,"canvas_visual_context_selection":null,"workspace_visual_order":null}',
        {"response_schema": TUTOR_OUTPUT_RESPONSE_SCHEMA},
    )
