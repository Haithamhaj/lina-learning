...
| **DEC-01** — Mode / Strategy / Prior-Relation Calibration | 3 | READY / NEXT APPROVED ACTION | S3 direct continuations remain NOT_RELEVANT or otherwise unstable. Do not replace Luna/Terra understanding with keyword routing. | Approved next action after accepted SUBJ-01; do not begin in this documentation-only transition. |
...
2. **B — Interaction / Evidence Hygiene:** ACT-02 CLOSED → CAND-01 strict
   ...
   → DEC-01 calibration (next approved action).
...
**Next action:** DEC-01 — Mode / Strategy / Prior-Relation Calibration. Browser
and Real-Lina validation remain separate. Do not begin EDU-ERR-01, REC-25,
