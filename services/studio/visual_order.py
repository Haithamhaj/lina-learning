...
def admit_visual_order(
    ...
    *,
    ...
    pack: dict[str, object] = {"version": FROZEN_COMPOSITION_PACK_SCHEMA_VERSION, "admitted_order": admitted_order, "semantic_alignment": alignment, "pattern": order.pattern, "topology": order.topology, "locale": order.locale, "direction": order.direction, "grounding": grounding, "visual_learner_context": learner_context, "capability_pack": {"identity": "SPECIALIST_CAPABILITY_PACK_V1", "process_stage_limit": [2, 8]}, "allowed_affordances": ["FOCUS_OBJECT", "DEEMPHASIZE_OTHERS", "REVEAL_OBJECT_DETAIL", "TRACE_RELATION", "TRANSITION_FOCUS"]}
