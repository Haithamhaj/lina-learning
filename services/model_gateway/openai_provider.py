...
def _normalize_output(
    ...
    *,
    ...
    try:
        ...
        if fallback_text and tutor_schema_name not in {"tutor_turn_v9", "tutor_turn_v10", "tutor_turn_v11", "tutor_turn_v12", "tutor_turn_v13"}:
            return {
                "text": fallback_text,
                "suggested_actions": [],
...
def _tutor_response_schema_name(payload: dict[str, object]) -> str | None:
    ...
    return name if name in {
        ...
        "tutor_turn_v9",
        "tutor_turn_v10",
        "tutor_turn_v11", "tutor_turn_v12", "tutor_turn_v13",
    } else None
